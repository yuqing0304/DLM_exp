...
def acc_eval_compute(labels, aux_inpute, message, valid_len, pad_id):
    ...
    if language == 'initial_local' or language == 'initial_long' or language == 'final_local' or language == 'final_long' or language == 'initial_test' or language == 'initial_uniformlong' or language == 'initial_skewedlong' or language == 'initial_mediumlong' or language == 'initial_uniformlocal' or language == 'initial_skewedlocal' or language == 'initial_mediumlocal' or language == 'final_uniformlong' or language == 'final_skewedlong' or language == 'final_uniformlocal' or language == 'final_skewedlocal':
        ...
        to7_2 = [0, 6, 7, 1, 2, 3, 4, 5, 8, 9]
        to2_7 = [0, 3, 4, 5, 6, 7, 1, 2, 8, 9]

        to7_5 = [0, 3, 4, 5, 6, 7, 1, 2, 8, 9]
        to5_7 = [0, 6, 7, 1, 2, 3, 4, 5, 8, 9]
        ...
        for i, j in mk_locate:
            if j == 2:
                new_l = labels[i][to2_7]
            elif j == 5:
                new_l = labels[i][to5_7]
            elif j == 7:
                if sorted_inanimate_locate[i][1] == 2:
                    new_l = labels[i][to7_2]
                elif sorted_inanimate_locate[i][1] == 4:
                    new_l = labels[i][to7_5]  
            else:
                new_l = None
            new_labels.append(new_l)
