...
def main(params: List[str], suffix) -> None:
    ...
    opts.listener_embedding_size = 512
...
if __name__ == "__main__":
    ...
    hyperdict = {'language': ['initial_skewedlocal'], 'trainset_proportion': [0.667], 'speaker_hidden_size': [1024], 'listener_hidden_size': [1024],'meaning_embedding_dim': [16], 'spk_entropy_coeff': [0.1], 'batch_size': [32], 'word_dropout_p': [0.1], 'random_seed': [
