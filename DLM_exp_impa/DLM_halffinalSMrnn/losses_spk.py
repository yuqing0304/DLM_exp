...
def acc_eval_compute(labels, aux_inpute, message, valid_len, pad_id):
    ...
    # inanimate_idx4 = aux_inpute['inanimate_idx4'][0].item()
    ...
    # inanimate_locate4 = torch.nonzero(torch.eq(labels, inanimate_idx4))
    ...
    acc = corr1 * 1.0
    if language == 'initial_local' or language == 'initial_long' or language == 'final_local' or language == 'final_long' or language == 'initial_test' or language == 'final_uniformlong' or language == 'final_skewedlong' or language == 'initial_mediumlong' or language == 'final_uniformlocal' or language == 'final_skewedlocal' or language == 'initial_mediumlocal':
        acc = corr1 * 1.0    
    elif language == 'initial_none' or language == 'initial_uniform' or language == 'initial_skewed' or language == 'initial_medium':
        to7_3 = [0, 1, 7, 8, 2, 3, 4, 5, 6, 9]
        to4_3 = [0, 1, 4, 5, 6, 7, 8, 2, 3, 9]

        to3_7 = [0, 1, 4, 5, 6, 7, 8, 2, 3, 9]
        to3_4 = [0, 1, 7, 8, 2, 3, 4, 5, 6, 9]
        ...
        for i, j in mk_locate:
            if j == 8:
                ...
                if sorted_inanimate_locate[i][1] == 8:
        ...
        # print(f"sorted_inanimate_locate: {sorted_inanimate_locate}")
        # print("labels", labels)
 
        to6_2 = [0, 6, 7, 1, 2, 3, 4, 5, 8, 9]
        to2_6 = [0, 3, 4, 5, 6, 7, 1, 2, 8, 9]

        to6_5 = [0, 3, 4, 5, 6, 7, 1, 2, 8, 9]
        to5_6 = [0, 6, 7, 1, 2, 3, 4, 5, 8, 9]
        ...
        for i, j in mk_locate:
            if j == 2:
                ...
                elif sorted_inanimate_locate[i][1] == 4:
