...
if __name__ == "__main__":
    ...
    hyperdict = {'language': ['final_skewedlocal'], 'trainset_proportion': [0.667], 'speaker_hidden_size': [64], 'listener_hidden_size': [64],'meaning_embedding_dim': [8], 'spk_entropy_coeff': [0.1], 'batch_size': [32], 'word_dropout_p': [0], 'random_seed': [
