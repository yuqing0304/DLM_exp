...
if __name__ == "__main__":
    ...
    hyperdict = {'language': ['initial_skewed'], 'trainset_proportion': [0.667], 'speaker_hidden_size': [512], 'listener_hidden_size': [512],'meaning_embedding_dim': [128], 'spk_entropy_coeff': [0.1], 'batch_size': [32], 'word_dropout_p': [0], 'random_seed': [
