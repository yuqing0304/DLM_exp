...
def main(params: List[str], suffix) -> None:
    ...
    optimizer = core.build_optimizer(game_lst.parameters(), lr=0.005)
    ...
    optimizer = core.build_optimizer(game_spk.parameters(), lr=0.005)
    optimizer_scheduler = None
    ...
    optimizer = core.build_optimizer(game_selfplay.parameters(), lr=0.002)
    optimizer_scheduler = None
...
# 0.01, 0.01, 0.001, lst_emb=8, mean_emb=8, spk_hidden=64, lst_hidden=128
    hyperdict = {'language': ['final_uniformlocal'], 'trainset_proportion': [0.667], 'speaker_hidden_size': [64], 'listener_hidden_size': [128],'meaning_embedding_dim': [8], 'spk_entropy_coeff': [0.1], 'batch_size': [32], 'word_dropout_p': [0.1], 'random_seed': [
