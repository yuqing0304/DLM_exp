...
# 32, 128, 0.01, 0.005, as expected
    hyperdict = {'language': ['initial_uniformlocal'], 'trainset_proportion': [0.667], 'speaker_hidden_size': [64], 'listener_hidden_size': [128],'meaning_embedding_dim': [8], 'spk_entropy_coeff': [0.1], 'batch_size': [32], 'word_dropout_p': [0], 'random_seed': [
