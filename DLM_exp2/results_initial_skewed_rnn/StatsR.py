...
# Define communication and speaker files (NEW SET)
comm_files = [
    ("512_512_noise0.txt", "normal"),
    ("512_512_noise0.1.txt", "noise"),
    ("256_512_noise0.txt", "limited"),
    ("256_512_noise0.1.txt", "noise_limited"),
]

spk_files = {
    "normal": "512_512_noise0spk.txt",
    "noise": "512_512_noise0.1spk.txt",
    "limited": "256_512_noise0spk.txt",
    "noise_limited": "256_512_noise0.1spk.txt",
}
...
# Write to CSV
output_path = "production_initial_R_exp2.csv"
