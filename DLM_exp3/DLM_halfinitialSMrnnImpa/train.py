...
def main(params: List[str], suffix) -> None:
    ...
    optimizer = core.build_optimizer(game_selfplay.parameters(), lr=0.00001) # 0.00003
    optimizer_scheduler = None
...
if __name__ == "__main__":
    ...
    # meaning_embedding_dim = 64
    hyperdict = {'language': ['initial_skewed'], 'trainset_proportion': [0.667], 'speaker_hidden_size': [1024], 'listener_hidden_size': [1024],'meaning_embedding_dim': [128], 'spk_entropy_coeff': [0.1], 'batch_size': [32], 'word_dropout_p': [0.1], 'random_seed': [
