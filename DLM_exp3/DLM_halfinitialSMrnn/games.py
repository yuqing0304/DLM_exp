...
from archs import Commu_Game2, SpeakerListener
from losses import MyLoss
from games_lst import build_game_lst
from games_spk import build_game_spk
...
def build_game_after_supervised(
    ...
    if game_type == 'speak':
        ...
        game2 = Commu_Game2(train_mode=train_mode, spk_lst=spk_lst, loss=loss, train_logging_strategy=train_logging_strategy, spk_entropy_coeff=spk_entropy_coeff)
