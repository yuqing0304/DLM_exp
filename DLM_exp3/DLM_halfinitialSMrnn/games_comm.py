...
from archs import RLSpeaker_decoder
from archs_spk import Speaker
from archs_lst import Listener
from archs_spk import Speaker_Game, Speaker_encoder
from losses_spk import MyLoss_spk, MyLoss_spk_v2
from losses_spk import MyLoss_spk_v2
from archs_lst import Listener_Game, Listener_encoder, Listener_decoder
from losses_lst import MyLoss_lst
...
def build_game_comm_lst(
    ...
    listener_enc = Listener_encoder(vocab_size=uttr_vocab_size, max_len=meaning_max_len, emb_size=embedding_size, hidden_size=encoder_hidden_size, word_dropout_p=word_dropout_p, dropout_constant=dropout_constant, rnn_cell=rnn_cell, variable_lengths=True, sos_id=sos_id, eos_id=eos_id, pad_id=pad_id)
